...
class MultiHeadAttentionTest(test_combinations.TestCase):
    ...
    def test_compute_output_shape(
        ...
        """Test compute_output_shape result is equal to the layer output's shape"""
        test_layer = keras.layers.MultiHeadAttention(
            num_heads=2,
            key_dim=2,
            value_dim=2,
        ...
        comp_output_shape = test_layer.compute_output_shape(query_shape, value_shape, key_shape)
        self.assertEqual(output.shape.as_list(), comp_output_shape.as_list())
   
    @parameterized.named_parameters(
        ("query_value_dim_mismatch", (None, 40, 80), (None, 20, 70), None),
        ("key_value_dim_mismatch", (None, 40, 80), (None, 20, 80), (None, 10, 70)),
        ("key_value_dim_mismatch_high_dim", (None, 40, 20, 30, 80), (None, 10, 10, 50, 80), (None, 10, 15, 50, 20)),
     )       
